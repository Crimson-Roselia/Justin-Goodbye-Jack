...
public class SpectrumAnalyzer : MonoBehaviour
{
    ...
    [SerializeField] private Transform pillarsParent;
    ...
    private void CreatePillarsByShapes()
    {
        ...
        pillars = MathB.ShapesOfGameObjects(currentPrefabType, pillarsParent.position, settings.pillar.radius, (int) settings.pillar.amount,settings.pillar.shape);

        //Organize pillars nicely in this folder under this transform
        folder = new GameObject("Pillars-" + pillars.Count);
        folder.transform.SetParent(pillarsParent);
